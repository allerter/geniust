...
def display_artist(update, context):
    ...
    buttons = [
        [IButton("List Songs (By Popularity)", f"artist_{artist['id']}_songs_ppl")],
        [IButton("List Songs (By Release Date)", f"artist_{artist['id']}_songs_rdt")],
        [IButton("List Songs (By Title)", f"artist_{artist['id']}_songs_ttl")],
        [IButton("List Albums", f"artist_{artist['id']}_albums")],
    ]
