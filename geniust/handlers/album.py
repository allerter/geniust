...
from telegram import InlineKeyboard as IBKeyboard
from telegram.error import TimedOut, NetworkError
from telegram.utils.helpers import create_deep_linked_url

from constants import (
    TYPING_ALBUM, END,
    database, genius, utils, username
)
...
def display_album_formats(update, context):
    ...
    buttons = [
        [IButton("PDF", f"album_{album_id}_aio_pdf")],
        [IButton("TELEGRA.PH", f"album_{album_id}_aio_tgf")],
        [IButton("ZIP", f"album_{album_id}_aio_zip")],
        [IButton("<- Back", f"album_{album_id}_aio_back")]
    ]
